...
if(keymoto_get_theme_mod('preloader_page_show') == 'true') {
    wp_enqueue_script( 'keymoto-page-loader' );?>
    <div id="fl-page--preloader">
        ...
        <img alt="<?php echo esc_attr__('Save Preloader image','keymoto');?>" src="<?php echo esc_url(keymoto_get_theme_mod( 'site_logo')); ?>" class="save_loader_bugs">
