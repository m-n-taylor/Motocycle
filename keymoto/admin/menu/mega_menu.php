<?php
if ( ! function_exists( 'keymoto_fontawesome_menu_icons' ) ) :
    function keymoto_fontawesome_menu_icons() {
...
if (!class_exists('KEYMOTO_Mega_menu')) {
	class KEYMOTO_Mega_menu {
		...
		public static function options() {
            $icon_ListMenu = keymoto_fontawesome_menu_icons();


			return array(
			    '_keymoto_mega_menu_icon'	=> array(
                    'type'      => 'select_icon',
                    'label'     => esc_html__('Select Icon', 'keymoto'),
                    'default'   => 0,
                    'options'   => $icon_ListMenu,
                    'size'      => 'wide',
                ),
				'_keymoto_mega_menu_image'	=> array(
						'type' => 'upload',
						'label' => esc_html__('Image', 'keymoto'),
						'default' => '',
						'size' => 'wide',
						'depth' => '0',  
						'class' => 'keymoto-show-only-depth-0',
					),
				
				'_keymoto_mega_menu_bg_position'	=> array(
						'type' => 'select',
						'label' => esc_html__( 'Background position', 'keymoto' ),
						'default' => 0,
						'options' => array(
								'left top'              => esc_html__('Left top', 'keymoto'),
								'left center'           => esc_html__('Left center', 'keymoto'),
								'left bottom'           => esc_html__('Left bottom', 'keymoto'),
								'right top'             => esc_html__('Right top', 'keymoto'),
								'right center'          => esc_html__('Right center', 'keymoto'),
								'right bottom'          => esc_html__('Right bottom', 'keymoto'),
								'center top'            => esc_html__('Center top', 'keymoto'),
								'center center'         => esc_html__('Center center', 'keymoto'),
								'center bottom'         => esc_html__('Center bottom', 'keymoto')
							),
						'size' => 'thin',
						'depth' => '0',
						'class' => 'keymoto-show-only-depth-0',
					),
				'_keymoto_mega_menu_bg_repeat'	=> array(
						'type' => 'select',
						'label' => esc_html__( 'Background repeat', 'keymoto' ),
						'default' => 'no-repeat',
						'options' => array(
								'no-repeat'         => esc_html__( 'No-repeat', 'keymoto' ),
								'repeat'            => esc_html__( 'Repeat', 'keymoto' ),
								'repeat-x'          => esc_html__( 'Repeat-x', 'keymoto' ),
								'repeat-y'          => esc_html__( 'Repeat-y', 'keymoto' ),
							),
						'size' => 'thin',
						'depth' => '0',
						'class' => 'keymoto-show-only-depth-0',
					),
				'_keymoto_mega_menu_enabled'	=> array(
						'type' => 'select',
						'label' => esc_html__( 'Enable mega menu', 'keymoto' ),
						'default' => 0,
						'options' => array(
						    1=> esc_html__( 'Yes', 'keymoto' ),
                            0=> esc_html__( 'No', 'keymoto' )),
						'size' => 'thin',
						'depth' => '0',
						'class' => 'keymoto-show-only-depth-0 keymoto-mega-menu',
					),
				'_keymoto_full_width_menu_enabled'	=> array(
						'type' => 'select',
						'label' => esc_html__( 'Enable full-width menu', 'keymoto' ),
						'default' => 0,
						'options' => array(
						    1=> esc_html__( 'Yes', 'keymoto' ),
                            0=> esc_html__( 'No', 'keymoto' )),
				...
				'_keymoto_mega_menu_limit_columns'	=> array(
						'type' => 'select',
						'label' => esc_html__( 'Limit Max columns number', 'keymoto' ),
						'default' => 0,
						'options' => array(
								''	=>	esc_html__( 'None', 'keymoto' ),
								1	=>	esc_html__( 'One columns', 'keymoto' ),
								2	=>	esc_html__( 'Two columns', 'keymoto' ),
								3	=>	esc_html__( 'Three columns', 'keymoto' ),
                                4	=>	esc_html__( 'Four columns', 'keymoto' ),
                                5	=>	esc_html__( 'Five columns', 'keymoto' ),
							),
						'size' => 'thin',
						'depth' => '0',
						'class' => 'keymoto-show-only-depth-0 keymoto-columns-limit',
					),
			);
		}
		...
		private function _add_filters() {
			...
			add_action('admin_enqueue_scripts', array( $this, 'keymoto_mega_menu_admin_scripts' ), 80);
		}
		
		
 
		function keymoto_mega_menu_admin_scripts() {
			wp_enqueue_media();
		}
		...
		public function apply_edit_walker_class( $walker, $menu_id ) {
			return KEYMOTO_EDIT_MENU_WALKER_CLASS;
		}
	}
}
