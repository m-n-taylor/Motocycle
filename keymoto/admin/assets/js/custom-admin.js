...
jQuery( function( $ ) {
 ...
 $(this).after("<div class='vc_preview_info';><i class='fa fa-info-circle' aria-hidden='true'></i></div><div class='vc_preview_obv';  ><img src='../wp-content/plugins/keymoto-custom/images/" + IDEl + ".jpg'></div>");
...
jQuery(document).ready(function($){
	...
	$.getJSON('https://www.googleapis.com/webfonts/v1/webfonts?key=AIzaSyAQlLPWmcSKzag88vWGjODuYNFafYL7YGM', function(data) {
	    ...
	    $dropdowns.each(function(){
	        ...
	        $container_id = $data_customize.replace(/keymoto_/i, '');
