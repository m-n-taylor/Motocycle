(function($) {
	...
	$(document).ready(function() {
		...
		$('.edit-menu-item-_keymoto_mega_menu_enabled').each(function() {
			var $self = $(this);
			var $image_select = $self.parent().parent().siblings('.field-_keymoto_mega_menu_image');
			var $image_position = $self.parent().parent().siblings('.field-_keymoto_mega_menu_bg_position');
			var $image_repeat = $self.parent().parent().siblings('.field-_keymoto_mega_menu_bg_repeat');
			var $columns_limit = $self.parent().parent().siblings('.field-_keymoto_mega_menu_limit_columns');
			if($self.val() == 0) {
				$image_select.hide();
				$image_position.hide();
				$image_repeat.hide();
